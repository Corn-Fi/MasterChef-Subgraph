...
export class MasterChef extends ethereum.SmartContract {
  ...
  cob(): Address {
    let result = super.call("cob", "cob():(address)", []);

    return result[0].toAddress();
  }

  try_cob(): ethereum.CallResult<Address> {
    let result = super.tryCall("cob", "cob():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  cobPerBlock(): BigInt {
    let result = super.call("cobPerBlock", "cobPerBlock():(uint256)", []);

    return result[0].toBigInt();
  }

  try_cobPerBlock(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("cobPerBlock", "cobPerBlock():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  pendingCob(_pid: BigInt, _user: Address): BigInt {
    let result = super.call(
      "pendingCob",
      "pendingCob(uint256,address):(uint256)",
      [
  ...
  try_pendingCob(_pid: BigInt, _user: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "pendingCob",
      "pendingCob(uint256,address):(uint256)",
      [
